...
namespace GunCube.Modules.World
{
    ...
    public class Effect
    {
        ...
        public static void Load()
        {
            ...
            AddEffect(new DefinedEffect((byte)Effects.Laser_Trail_Red, 255, 0, 0, 0f, 1, 2, 15, 5, 5, 10, 10) { BaseLifetime = 0.3f, LifetimeVariation=0f, Spread = 0.10f, SizeVariation = 0.1f, Speed =0.05f, FullBright=true, CollidesSolid=false, CollidesLeaves=false, CollidesLiquid=false});
            AddEffect(new DefinedEffect((byte)Effects.Laser_Trail_Red2, 255, 100, 100, 0f, 1, 2, 15, 5, 5, 10, 10) { BaseLifetime = 0.3f, LifetimeVariation = 0f, Size=3, SizeVariation = 0.1f, Spread = 0f, FullBright = true, CollidesSolid = false, CollidesLeaves = false, CollidesLiquid = false });
            AddEffect(new DefinedEffect((byte)Effects.Laser_Hit_Red) { R = 255, G =245, B = 157, ParticleCount = 10, SizeVariation = 0.2f, Size = 25, Spread = 0.4f, FrameCount = 1, Gravity = 4f, Speed = 3f, BaseLifetime = 4f, LifetimeVariation = 0.5f, FullBright=true, CollidesSolid=false, CollidesLiquid=true });


            AddEffect(new DefinedEffect((byte)Effects.Bullet_Trail, 50, 50, 50, 0f, 1, 2, 15, 5, 5, 10, 10) { BaseLifetime = 0.3f, LifetimeVariation = 0f, Spread = 0.10f, SizeVariation = 0.1f, Speed = 0.05f, FullBright = true, CollidesSolid = false, CollidesLeaves = false, CollidesLiquid = false });
            AddEffect(new DefinedEffect((byte)Effects.Bullet_Trail2, 100, 100, 100, 0f, 1, 2, 15, 5, 5, 10, 10) { BaseLifetime = 0.3f, LifetimeVariation = 0f, Size = 3, SizeVariation = 0.1f, Spread = 0f, FullBright = true, CollidesSolid = false, CollidesLeaves = false, CollidesLiquid = false });
            AddEffect(new DefinedEffect((byte)Effects.Bullet_Hit) { R = 255, G = 245, B = 157, ParticleCount = 10, SizeVariation = 0.2f, Size = 25, Spread = 0.4f, FrameCount = 1, Gravity = 4f, Speed = 3f, BaseLifetime = 4f, LifetimeVariation = 0.5f, FullBright = true, CollidesSolid = false, CollidesLiquid = true });
